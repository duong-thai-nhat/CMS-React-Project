...
import { AccNotiEMail } from "../AccNotiEMail/AccNotiEMail"
    ...
    return (
        <header className="header">
            <div className="header-input-search">
                ...
                <svg className="header-search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
